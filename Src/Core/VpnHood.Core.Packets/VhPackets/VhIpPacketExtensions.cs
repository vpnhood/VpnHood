...
public static class VhIpPacketExtensions
{
    ...
    public static bool IsChecksumValid(this IChecksumsPayloadPacket payloadPacket, VhIpPacket ipPacket)
    {
        return payloadPacket
            .IsChecksumValid(ipPacket.SourceAddressSpan, ipPacket.DestinationAddressSpan);
    }

    public static ushort ComputeChecksum(this IChecksumsPayloadPacket payloadPacket, VhIpPacket ipPacket)
    {
        return payloadPacket
            .ComputeChecksum(ipPacket.SourceAddressSpan, ipPacket.DestinationAddressSpan);
    }

    public static void UpdateChecksum(this IChecksumsPayloadPacket payloadPacket, VhIpPacket ipPacket)
    {
        payloadPacket
