...
$linuxScript = (Get-Content -Path "$PSScriptRoot/Install/$installScriptFileName" -Raw).Replace('$installUrlParam', "https://github.com/vpnhood/VpnHood/releases/download/$versionTag/$publishInfoPackageFile");
