...
# NOTE: The old Changelog_UpdateHeader (which rewrote a leading "# Upcoming" header into "# v<version>")
# was removed. The CHANGELOG is now maintained by hand under a leading "# Latest" heading and CI never
# rewrites it — Changelog_GetRecentSecion above just reads the first H1 section for the release note.