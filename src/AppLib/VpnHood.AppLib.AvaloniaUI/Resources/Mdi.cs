...
// Material Design Icons, the web UI's icon set, drawn from the font in Assets/Fonts by code point:
// the same glyph the web UI shows for the same name, and nothing to convert when a page is ported.
public static class Mdi
{
    public const string FontFamily = "avares://VpnHood.AppLib.AvaloniaUI/Assets/Fonts#Material Design Icons";
