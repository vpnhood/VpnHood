...
// mechanics, and reporting what happened to it. WebViewHost decides what to do about it.
//
// Threading contract: WebViewHost calls the methods below on the platform UI thread (it hops
...
public interface IWebView
{
    ...
    // Marshal an action onto the platform UI thread. WebViewHost uses this so its background
