...
// start, stop and look at it. Deliberately not "the service": on Linux it is a systemd unit, on
// Windows it is the elevated tray app, in a Store build it is whatever the package launches, and
// the commands must not care which. Each platform answers these in its own terms.
//
