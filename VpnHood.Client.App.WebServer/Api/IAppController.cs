...
public interface IAppController
{
    ...
    Task Connect(Guid? clientProfileId = null, string? serverLocation = null, string? plan = null);
    Task Diagnose(Guid? clientProfileId = null, string? serverLocation = null, string? plan = null);
    Task Disconnect();
