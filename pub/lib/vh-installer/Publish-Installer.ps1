...
# Strict: Connect must carry a default server access key. Installers are ad-free direct downloads, so
# "web" maps to the 'premium' key (access_key_premium.txt) inside Assert-DefaultAccessKey. No-ops for
# Client and Server (neither passes -connect).
