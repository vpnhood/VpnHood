...
$json = @{
	...
	UpdateInfoUrl = "$publishRepoUrl/releases/latest/download/$module_infoFileName";
	PackageUrl = "$publishRepoUrl/releases/download/$versionTag/$module_packageFileName";
