...
Unlike Windows/Linux (`VpnHood.Net.Quic.MsQuic`), this project does **not** use `System.Net.Quic`.
It is conceptually the Android sibling of `VpnHood.Net.Quic.Ios` (which is its own client over
