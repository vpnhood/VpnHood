...
SELECT TOP 1000 T.supportId, --
    ...
    dbo.Convert_formatTraffic(AU.cycleSentTraffic) AS cycleSentTraffic, --
    dbo.Convert_formatTraffic(AU.cycleReceivedTraffic) AS cycleReceivedTraffic, --
	dbo.Convert_formatTraffic(AU.cycleSentTraffic + AU.cycleReceivedTraffic) AS cycleTraffic, --
  ...
  FROM  dbo.AccessUsage AS AU
		...
		ORDER BY (AU.cycleSentTraffic + AU.cycleReceivedTraffic) DESC
GO
