...
namespace VpnHood.AccessServer.Test
{
    ...
    public class AccessTokenController_Test : ControllerTest
    {
        ...
        public async Task CRUD_public()
        {
            ...
            Assert.AreEqual(TestInit.TEST_AccessTokenGroup2, accessToken2A.AccessTokenGroupId);
            ...
            Assert.AreEqual(TestInit.TEST_ServerEndPoint_G2S1, token.ServerEndPoint);
