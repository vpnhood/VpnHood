...
public class DnsConfigurationTest : TestBase
{
    ...
    public async Task Server_specify_dns_servers()
    {
        ...
        CollectionAssert.AreEqual(fileAccessManagerOptions.DnsServers, client.Session?.Config.SessionInfo.DnsConfig.DnsServers);
        Assert.IsFalse(client.Session?.Config.SessionInfo.DnsConfig.IsUserSuppressed);
    }
    ...
    public async Task Client_specify_dns_servers()
    {
        ...
        CollectionAssert.AreEqual(clientOptions.DnsServers, client.Session?.Config.SessionInfo.DnsConfig.DnsServers);
        Assert.IsFalse(client.Session?.Config.SessionInfo.DnsConfig.IsUserSuppressed);
    }
    ...
    public async Task Server_override_dns_servers()
    {
        ...
        CollectionAssert.AreEqual(fileAccessManagerOptions.DnsServers, client.Session?.Config.SessionInfo.DnsConfig.DnsServers);
        Assert.IsTrue(client.Session?.Config.SessionInfo.DnsConfig.IsUserSuppressed);
    }
