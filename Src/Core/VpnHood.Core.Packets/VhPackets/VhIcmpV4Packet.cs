...
public class VhIcmpV4Packet : IChecksumPayloadPacket
{
    ...
    public IcmpV4TypeCode TypeCode {
        get => (IcmpV4TypeCode)((_buffer.Span[0] << 8) | _buffer.Span[1]);
        set {
            Type = (IcmpV4Type)((ushort)value >> 8);
            Code = (byte)((ushort)value & 0xFF);
        }
    }
    ...
    {
        return $"ICMPv4 Packet: TypeCode={TypeCode}, Id={Identifier}, Seq={SequenceNumber}, PayloadLen={Payload.Length}";
    }
}
