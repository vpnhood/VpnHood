...
public class DnsConfigurationTest : TestBase
{
    ...
    public async Task Server_specify_dns_servers()
    {
        ...
        CollectionAssert.AreEqual(fileAccessManagerOptions.DnsServers, client.RequiredSession.Info.DnsConfig.DnsServers);
        Assert.IsFalse(client.RequiredSession.Info.DnsConfig.IsUserSuppressed);
    }
    ...
    public async Task Client_specify_dns_servers()
    {
        ...
        CollectionAssert.AreEqual(clientOptions.DnsServers, client.RequiredSession.Info.DnsConfig.DnsServers);
        Assert.IsFalse(client.RequiredSession.Info.DnsConfig.IsUserSuppressed);
    }
    ...
    public async Task Server_override_dns_servers()
    {
        ...
        CollectionAssert.AreEqual(fileAccessManagerOptions.DnsServers, client.RequiredSession.Info.DnsConfig.DnsServers);
        Assert.IsTrue(client.RequiredSession.Info.DnsConfig.IsUserSuppressed);
    }
