    ...
    public async Task<IPacketCapture> CreatePacketCapture(IUiContext? uiContext)
    {
        ...
        if (prepareIntent != null)
        {
            ...
            try
            {
                ...
                await Task.WhenAny(_grantPermissionTaskSource.Task, Task.Delay(TimeSpan.FromMinutes(2))).ConfigureAwait(false);
        ...
        await Task.WhenAny(_startServiceTaskSource.Task, Task.Delay(TimeSpan.FromSeconds(10))).ConfigureAwait(false);
