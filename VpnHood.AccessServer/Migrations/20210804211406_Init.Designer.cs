...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VpnHood.AccessServer.Models.AccessToken", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "SupportCode")
                        .IsUnique();
            ...
            modelBuilder.Entity("VpnHood.AccessServer.Models.AccessTokenGroup", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "AccessTokenGroupName")
                        .IsUnique();
            ...
            modelBuilder.Entity("VpnHood.AccessServer.Models.Project", b =>
                {
                    b.Property<Guid>("ProjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("VpnHood.AccessServer.Models.Server", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "ServerName")
                        .IsUnique()
            ...
            modelBuilder.Entity("VpnHood.AccessServer.Models.ServerEndPoint", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "PrivateEndPoint")
                        .IsUnique()
                        .HasFilter("PrivateEndPoint IS NOT NULL");

                    b.HasIndex("ProjectId", "PulicEndPoint")
                        .IsUnique();
            ...
            modelBuilder.Entity("VpnHood.AccessServer.Models.AccessToken", b =>
                {
                    ...
                    b.HasOne("VpnHood.AccessServer.Models.Project", "Project")
                        .WithMany("AccessTokens")
