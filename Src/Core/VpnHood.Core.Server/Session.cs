...
public class Session : IDisposable
{
        ...
        VirtualIpBundle virtualIps)
    {
        ...
        _proxyManager = new ProxyManager(socketFactory, new ProxyManagerOptions {
            ...
            UdpReceiveBufferSize = options.UdpProxyReceiveBufferSizeValue ?? TunnelDefaults.ServerUdpProxyReceiveBufferSize,
            UdpSendBufferSize = options.UdpProxySendBufferSizeValue ?? TunnelDefaults.ServerUdpProxySendBufferSize,
            LogScope = logScope,
