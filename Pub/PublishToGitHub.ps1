...
gh release create "$versionTag" `
	...
	$releaseRootDir/$packageClientDirName/android-web/VpnHoodClient-android$androidStore.apk `
	$releaseRootDir/$packageClientDirName/android-web/VpnHoodClient-android$androidStore.json `
