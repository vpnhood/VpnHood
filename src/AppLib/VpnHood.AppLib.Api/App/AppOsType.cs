...
// The OS the app process is running on, published to the UI through AppFeatures.
//
// The UI needs this because some content is only legal//useful on certain platforms: an App Store
