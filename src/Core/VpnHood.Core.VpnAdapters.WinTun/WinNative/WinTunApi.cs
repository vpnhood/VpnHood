...
internal static class WinTunApi
{
    ...
    public static extern IntPtr WintunCreateAdapter([MarshalAs(UnmanagedType.LPWStr)] string adapterName,
        [MarshalAs(UnmanagedType.LPWStr)] string tunnelType, in Guid requestedGuid);

    [DllImport("wintun.dll", SetLastError = true)]
    public static extern IntPtr WintunCreateAdapter([MarshalAs(UnmanagedType.LPWStr)] string adapterName,
        [MarshalAs(UnmanagedType.LPWStr)] string tunnelType, IntPtr requestedGuid);
    ...
    [DllImport("wintun.dll", SetLastError = true, CallingConvention = CallingConvention.Cdecl,
