...
export class AppFeatures implements IAppFeatures {
    ...
    toJSON(data?: any) {
        ...
        data["version"] = this.version ? this.version.toJSON() : null as any;
        return data;
    }
}
...
export class Version implements IVersion {
    ...
    init(_data?: any) {
        if (_data) {
            this.major = _data["major"] !== undefined ? _data["major"] : null as any;
            this.minor = _data["minor"] !== undefined ? _data["minor"] : null as any;
            this.build = _data["build"] !== undefined ? _data["build"] : null as any;
            this.revision = _data["revision"] !== undefined ? _data["revision"] : null as any;
            this.majorRevision = _data["majorRevision"] !== undefined ? _data["majorRevision"] : null as any;
            this.minorRevision = _data["minorRevision"] !== undefined ? _data["minorRevision"] : null as any;
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["major"] = this.major !== undefined ? this.major : null as any;
        data["minor"] = this.minor !== undefined ? this.minor : null as any;
        data["build"] = this.build !== undefined ? this.build : null as any;
        data["revision"] = this.revision !== undefined ? this.revision : null as any;
        data["majorRevision"] = this.majorRevision !== undefined ? this.majorRevision : null as any;
        data["minorRevision"] = this.minorRevision !== undefined ? this.minorRevision : null as any;
        return data;
    }
}
...
export class AppSessionInfo implements IAppSessionInfo {
    ...
    clientPublicIpAddress!: IPAddress;
    createdTime!: Date;
    channelProtocols!: ChannelProtocol[];
    isTcpProxySupported!: boolean;
    ...
    constructor(data?: IAppSessionInfo) {
        ...
        if (!data) {
            ...
            this.clientPublicIpAddress = new IPAddress();
            this.channelProtocols = [];
        }
    }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.serverVersion = _data["serverVersion"] ? Version.fromJS(_data["serverVersion"]) : new Version();
            this.clientPublicIpAddress = _data["clientPublicIpAddress"] ? IPAddress.fromJS(_data["clientPublicIpAddress"]) : new IPAddress();
            this.createdTime = _data["createdTime"] ? new Date(_data["createdTime"].toString()) : null as any;
            if (Array.isArray(_data["channelProtocols"])) {
                this.channelProtocols = [] as any;
                for (let item of _data["channelProtocols"])
    ...
    toJSON(data?: any) {
        ...
        data["serverVersion"] = this.serverVersion ? this.serverVersion.toJSON() : null as any;
        data["clientPublicIpAddress"] = this.clientPublicIpAddress ? this.clientPublicIpAddress.toJSON() : null as any;
        data["createdTime"] = this.createdTime ? this.createdTime.toISOString() : null as any;
        if (Array.isArray(this.channelProtocols)) {
            data["channelProtocols"] = [];
            for (let item of this.channelProtocols)
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["dnsServers"])) {
                ...
                for (let item of _data["dnsServers"])
                    this.dnsServers!.push(IPAddress.fromJS(item));
            }
            else {
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.dnsServers)) {
            ...
            for (let item of this.dnsServers)
                data["dnsServers"].push(item ? item.toJSON() : null as any);
        }
        return data;
    }
}
...
export class IPAddress implements IIPAddress {
    ...
    init(_data?: any) {
        if (_data) {
            this.privateAddress = _data["privateAddress"] !== undefined ? _data["privateAddress"] : null as any;
            this.privateIPv4Address = _data["privateIPv4Address"] !== undefined ? _data["privateIPv4Address"] : null as any;
            this.addressFamily = _data["addressFamily"] !== undefined ? _data["addressFamily"] : null as any;
            this.scopeId = _data["scopeId"] !== undefined ? _data["scopeId"] : null as any;
            this.isIPv6Multicast = _data["isIPv6Multicast"] !== undefined ? _data["isIPv6Multicast"] : null as any;
            this.isIPv6LinkLocal = _data["isIPv6LinkLocal"] !== undefined ? _data["isIPv6LinkLocal"] : null as any;
            this.isIPv6SiteLocal = _data["isIPv6SiteLocal"] !== undefined ? _data["isIPv6SiteLocal"] : null as any;
            this.isIPv6Teredo = _data["isIPv6Teredo"] !== undefined ? _data["isIPv6Teredo"] : null as any;
            this.isIPv6UniqueLocal = _data["isIPv6UniqueLocal"] !== undefined ? _data["isIPv6UniqueLocal"] : null as any;
            this.isIPv4MappedToIPv6 = _data["isIPv4MappedToIPv6"] !== undefined ? _data["isIPv4MappedToIPv6"] : null as any;
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["privateAddress"] = this.privateAddress !== undefined ? this.privateAddress : null as any;
        data["privateIPv4Address"] = this.privateIPv4Address !== undefined ? this.privateIPv4Address : null as any;
        data["addressFamily"] = this.addressFamily !== undefined ? this.addressFamily : null as any;
        data["scopeId"] = this.scopeId !== undefined ? this.scopeId : null as any;
        data["isIPv6Multicast"] = this.isIPv6Multicast !== undefined ? this.isIPv6Multicast : null as any;
        data["isIPv6LinkLocal"] = this.isIPv6LinkLocal !== undefined ? this.isIPv6LinkLocal : null as any;
        data["isIPv6SiteLocal"] = this.isIPv6SiteLocal !== undefined ? this.isIPv6SiteLocal : null as any;
        data["isIPv6Teredo"] = this.isIPv6Teredo !== undefined ? this.isIPv6Teredo : null as any;
        data["isIPv6UniqueLocal"] = this.isIPv6UniqueLocal !== undefined ? this.isIPv6UniqueLocal : null as any;
        data["isIPv4MappedToIPv6"] = this.isIPv4MappedToIPv6 !== undefined ? this.isIPv4MappedToIPv6 : null as any;
        return data;
    }
}
...
export class ClientProfileBaseInfo implements IClientProfileBaseInfo {
    ...
    customServerEndpoints!: IPEndPoint[] | null;
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["customServerEndpoints"])) {
                ...
                for (let item of _data["customServerEndpoints"])
                    this.customServerEndpoints!.push(IPEndPoint.fromJS(item));
            }
            else {
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.customServerEndpoints)) {
            ...
            for (let item of this.customServerEndpoints)
                data["customServerEndpoints"].push(item ? item.toJSON() : null as any);
        }
        return data;
    }
}
...
export abstract class EndPoint implements IEndPoint {
    ...
    static fromJS(data: any): EndPoint {
        data = typeof data === 'object' ? data : {};
        throw new Error("The abstract class 'EndPoint' cannot be instantiated.");
    }
...
export class IPEndPoint extends EndPoint implements IIPEndPoint {
    addressFamily!: AddressFamily;
    address!: IPAddress;
    port!: number;

    constructor(data?: IIPEndPoint) {
        super(data);
        if (!data) {
    ...
    override init(_data?: any) {
        ...
        if (_data) {
            this.addressFamily = _data["addressFamily"] !== undefined ? _data["addressFamily"] : null as any;
            this.address = _data["address"] ? IPAddress.fromJS(_data["address"]) : new IPAddress();
            this.port = _data["port"] !== undefined ? _data["port"] : null as any;
        }
    }

    static override fromJS(data: any): IPEndPoint {
        data = typeof data === 'object' ? data : {};
        let result = new IPEndPoint();
        result.init(data);
        return result;
    }
...
export interface IIPEndPoint extends IEndPoint {
    addressFamily: AddressFamily;
    address: IPAddress;
    port: number;
}
...
export class PublishInfo implements IPublishInfo {
    ...
    constructor(data?: IPublishInfo) {
        ...
        if (!data) {
            this.version = new Version();
            this.deprecatedVersion = new Version();
        }
    }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.deprecatedVersion = _data["deprecatedVersion"] ? Version.fromJS(_data["deprecatedVersion"]) : new Version();
    ...
    toJSON(data?: any) {
        ...
        data["deprecatedVersion"] = this.deprecatedVersion ? this.deprecatedVersion.toJSON() : null as any;
...
export class ProxyAutoUpdateOptions implements IProxyAutoUpdateOptions {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.removeDuplicateIps = _data["removeDuplicateIps"] !== undefined ? _data["removeDuplicateIps"] : null as any;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["removeDuplicateIps"] = this.removeDuplicateIps !== undefined ? this.removeDuplicateIps : null as any;
        return data;
    }
}
