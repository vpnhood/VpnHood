...
// of the bundle the web server extracts; then the UI is given the app's API (its own controllers
// in process, the same six interfaces a paired browser dials over HTTP) and the folder.
