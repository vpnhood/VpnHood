...
{
    public static readonly Version MinServerVersion = Version.Parse("2.4.301"); //todo replace soon
    //public static readonly Version MinServerVersion = Version.Parse("2.9.370"); 
